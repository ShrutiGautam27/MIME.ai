        ...
        <div className="sticky top-0 z-50 hidden md:flex justify-center items-center">
          ...
          >
            <div className="flex items-center space-x-8">
              ...
              <a
                href="/learning-hub"
                className="group relative text-gray-300 font-medium transition-all duration-500 hover:text-white hover:bg-clip-text hover:bg-gradient-to-r hover:from-blue-400 hover:to-cyan-400"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400/0 via-blue-400/5 to-blue-400/0 scale-0 group-hover:scale-100 transition-transform duration-500 rounded-lg"></div>
